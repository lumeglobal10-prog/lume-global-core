...
// 🏛️ RECTIFICACIÓN: COMPONENTE ATÓMICO PARA AISLAR useSearchParams()
function RegisterFormContent() {
  ...
  return (
    <div className="max-w-md w-full flex flex-col justify-center flex-grow">
      <h1 className="text-4xl md:text-5xl font-[400] tracking-[0.1em] leading-tight text-center mb-12 font-serif uppercase">
        REGISTRO DE ENTIDAD.
      </h1>
        ...
        <div className="flex flex-col items-center pt-4">
          {!showTokenInput ? (
            <span 
              ...
              className="text-[10px] font-[400] tracking-[0.5em] font-serif mb-6 cursor-pointer uppercase border-b border-black/10"
            >
              TOKEN
            </span>
          ) : (
          ...
          <button 
            ...
            className="w-full bg-black text-white p-6 rounded-[50px] text-[11px] font-[400] tracking-[0.5em] transition-none disabled:opacity-30 font-serif uppercase"
          >
...
// 🏛️ EXPORTACIÓN PRINCIPAL CON LÍMITE DE SUSPENSE (REQUERIMIENTO NEXT.js 14)
  ...
  return (
    <main className="h-screen w-full bg-[#FFFFFF] text-black flex flex-col items-center justify-between p-10 uppercase tracking-[0.2em] zero-scroll overflow-hidden">
      ...
      <nav className="w-full flex justify-between items-center shrink-0 z-50">
        ...
        <button 
          onClick={() => router.back()} 
          className="text-black text-[11px] font-[400] tracking-[0.3em] cursor-pointer font-serif border-b border-black/20 pb-1 uppercase bg-transparent"
        >
          ← VOLVER
        </button>
      </nav>

      <Suspense fallback={<div className="font-serif text-[10px] tracking-widest">SINCRONIZANDO KERNEL...</div>}>
        <RegisterFormContent />
      </Suspense>

      <footer className="w-full flex flex-col items-center gap-10 shrink-0">
        <div className="flex justify-center gap-14 text-[10px] font-[400] tracking-[0.3em] font-serif text-black/40 uppercase">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          />
          <p className="text-[9px] font-[400] text-[#333] opacity-40 tracking-[0.4em] italic font-serif uppercase text-center pb-4">
