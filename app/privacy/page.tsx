    ...
    <main className="min-h-screen bg-white text-black font-sans flex flex-col justify-between overflow-x-hidden">
      ...
      <section className="flex-grow flex flex-col items-center py-12 px-6 md:py-20">
        <article className="max-w-3xl w-full">
          <h1 className="text-3xl md:text-5xl font-extralight tracking-tight leading-tight mb-2 text-center">Políticas de Privacidad</h1>
          <p className="text-[10px] font-mono text-neutral-400 tracking-[0.2em] uppercase text-center mb-16">Compromiso: Soberanía del Dato</p>

          <div className="space-y-12 text-sm md:text-base leading-relaxed text-neutral-800">
            <section>
              <h2 className="text-[11px] font-black tracking-[0.3em] uppercase mb-4 text-black italic">1. Tratamiento de Activos</h2>
              <p>Lume Global Core procesa las imágenes suministradas únicamente con el fin de ejecutar los cálculos matemáticos de optimización. Los activos se gestionan en entornos aislados para garantizar la seguridad de la información.</p>
            </section>
            <section>
              <h2 className="text-[11px] font-black tracking-[0.3em] uppercase mb-4 text-black italic">2. Confidencialidad y Seguridad</h2>
              <p>No compartimos datos técnicos ni historiales de consumo con terceros. La información del suscriptor es tratada bajo protocolos de cifrado desde la subida hasta la entrega final del activo.</p>
            </section>
            <section>
              <h2 className="text-[11px] font-black tracking-[0.3em] uppercase mb-4 text-black italic">3. Registro Operativo</h2>
              <p>El sistema registra IPs y logs de actividad únicamente para fines de seguridad y prevención de fraude, cumpliendo con las normativas internacionales de protección de datos.</p>
            </section>
      ...
      <footer className="w-full p-6 border-t border-neutral-100 flex flex-col items-center gap-2 bg-white">
        ...
        <div className="flex gap-8 font-mono text-[9px] text-neutral-500 uppercase pb-2">
          ...
          <Link href="/privacy" className="text-black underline underline-offset-4 decoration-2">Privacidad</Link>
