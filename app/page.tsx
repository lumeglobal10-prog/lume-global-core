...
// ... (Mantenemos la constante PLANS igual)
...
export default function PricingPage() {
  ...
  const handleSelectPlan = (planId: string) => {
    ...
    // Disparar la interrupción inteligente
    setShowTaxPopup(true);
  };

  const proceedToCheckout = () => {
    // Aquí la lógica para conectar con el servidor de Londres/Pasarela
  ...
  return (
    <main className="min-h-screen bg-white text-black font-sans flex flex-col p-6 md:p-12">
      ...
      {/* Resto del diseño de planes... (Grilla de planes) */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto w-full">
        {PLANS.map((plan) => (
          ...
          >
            {/* Contenido del plan (nombre, precio, renders) */}
