      ...
      <div className="max-w-3xl w-full">
        ...
        <article className="space-y-10 text-sm leading-relaxed text-neutral-800 font-light">
          ...
          <section>
            ...
            <p>El sistema opera mediante procesos algorítmicos sin intervención de inteligencia artificial. Lume Global Core no garantiza que los resultados coincidan con expectativas subjetivas. La auditoría final del activo generado es responsabilidad del suscriptor.</p>
          </section>

          <section>
            <h2 className="text-[11px] font-bold uppercase tracking-[0.2em] text-black mb-4">Gestión de Pagos</h2>
            <p>Las transacciones son procesadas por terceros autorizados. Lume Global Core no almacena credenciales bancarias.</p>
          </section>
        </article>

        <footer className="mt-20 pt-8 border-t border-neutral-100 italic text-neutral-400 text-[10px] uppercase tracking-widest">
          LUME GLOBAL CORE // JURISDICCIÓN INTERNACIONAL
        </footer>
      </div>
    </main>
  );
